...
# 大世界采集、跳跃、移动相关的UI
AreaFPickup = Area()
TextFPickUp = Text("拾取", cap_area = AreaFPickup.position)
AreaFSkip = Area()
TextFSkip = Text("跳过", cap_area = AreaFSkip.position)
AreaClickSkip = Area()
TextClickSkip = Text("空白区域继续", cap_area = AreaClickSkip.position)
...
TextJihuatai = Text("打开素材激化台", cap_area = AreaTextJihuatai.position)

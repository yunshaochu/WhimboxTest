...
from whimbox.common.cvars import THREAD_PAUSE_FORCE_TERMINATE, THREAD_PAUSE_SET_FLAG_ONLY
...
class BaseThreading(threading.Thread):
    ...
    def __force_terminate(self):
        ...
        raise ThreadTerminated('If you see this error, it\'s just because the thread was terminated normally, not a fatal error.')
